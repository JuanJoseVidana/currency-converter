...
public class CountryToCurrencyMap {
    ...
    static {
        ...
        countryCurrencyMap.put("espana", "EUR");
        countryCurrencyMap.put("alemania", "EUR");
        countryCurrencyMap.put("reino unido", "GBP");
        countryCurrencyMap.put("japon", "JPY");
        ...
        countryCurrencyMap.put("republica dominicana", "DOP");
        countryCurrencyMap.put("el salvador", "USD");
        countryCurrencyMap.put("ecuador", "USD");
        countryCurrencyMap.put("suiza", "CHF");
        countryCurrencyMap.put("sudafrica", "ZAR");
        countryCurrencyMap.put("australia", "AUD");
        countryCurrencyMap.put("china", "CNY");
        countryCurrencyMap.put("india", "INR");
        countryCurrencyMap.put("rusia", "RUB");
        countryCurrencyMap.put("italia", "EUR");
        countryCurrencyMap.put("francia", "EUR");
